...
def plot_sfh_posterior(fit, show=False, save=True):
...
def add_sfh_posterior(fit, ax, colorscheme="bw", z_axis=True):
    ...
    ax.plot(x, post[:, 1], color=color1, zorder=6)
