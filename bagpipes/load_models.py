...
model_dirs["bc03_miles"] = install_dir + "/models/stellar/bc03_miles/"
#model_dirs["bc03_basel"] = install_dir + "/models/stellar/bc03_basel/"
#model_dirs["bpass_bin_100"] = install_dir + "/models/stellar/bpass_bin_100/"
#model_dirs["bpass_bin_300"] = install_dir + "/models/stellar/bpass_bin_300/"
#model_dirs["mar05"] = install_dir + "/models/stellar/mar05/"
...
def bc03_miles():
    ...
    len_wavs =  13216
    modelwavs = fits.open(install_dir + "/models/stellar/bc03_miles/bc03_miles_stellar_grids.fits")[-1].data
    ages = fits.open(install_dir + "/models/stellar/bc03_miles/bc03_miles_stellar_grids.fits")[-2].data #ages[0] = 0.
    live_mstar_frac = fits.open(install_dir + "/models/stellar/bc03_miles/bc03_miles_stellar_grids.fits")[-3].data

    return zmet_vals, modelwavs, ages, live_mstar_frac

def bc03_miles_get_grid(zmet_ind):
    return fits.open(install_dir + "/models/stellar/bc03_miles/bc03_miles_stellar_grids.fits")[zmet_ind+1].data
...
"""
def bc03_miles():
    zmet_fnames = np.loadtxt(install_dir + "/models/stellar/bc03_miles/bc03_miles_fnames.txt", dtype="str")
    ...
    mstar_liv = np.loadtxt(install_dir + "/models/stellar/bc03_miles/live_mass_fractions.txt")
...
"""
def bc03_basel():
    zmet_fnames = np.loadtxt(install_dir + "/models/stellar/bc03_basel_fnames.txt", dtype="str")
    zmet_vals = np.array([0.0001, 0.0004, 0.004, 0.008, 0.02, 0.05, 0.1])
    len_wavs =  1238
...
def bpass_bin_100():
    zmet_fnames = np.loadtxt(install_dir + "/models/stellar/bpass_bin_100_fnames.txt", dtype="str")
...
def bpass_bin_300():
    zmet_fnames = np.loadtxt(install_dir + "/models/stellar/bpass_bin_300_fnames.txt", dtype="str")
    zmet_vals = np.array([0.001, 0.002, 0.003, 0.004, 0.006, 0.008, 0.01, 0.014, 0.02, 0.03, 0.04])
    len_wavs = 100000
...
def mar05():
    zmet_fnames = np.loadtxt(install_dir + "/models/stellar/mar05_fnames.txt", dtype="str")
