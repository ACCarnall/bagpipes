...
Important note: The code will not run from simply cloning this repository. This is because the large model grid files aren't included. Instead download the latest version from the `installation page <http://bagpipes.readthedocs.io/en/stable/installation.html>`_ of the documentation.