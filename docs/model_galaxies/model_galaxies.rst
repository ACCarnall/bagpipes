...
In order to tell the code where to find filter curves for calculating observed photometry it is necessary to define a list of filter curves. Learn how to do this `here <filtlists.html>`_.

Bagpipes is designed to rapidly update the parameters of models of the same kind, in order to faciliate fitting. Learn how to use the **update** method of **Model_Galaxy** in order to generate large numbers of models quickly `here <updating.html>`_.
